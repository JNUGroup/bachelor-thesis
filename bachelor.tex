...
%【Enzyme-triggered model self-assembly in surfactant–cyclodextrin systems】的开关表面活性剂有待讨论。
    ...
    2015年Liu X F等\cite{zhang2015}报道了含硒磺基甜菜碱类表面活性剂，？？等
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width= .5\textwidth]{figure/vesicle-phase.png}\\
...
% 致谢，应放在《结论》之后
    \begin{acknowledgement}
        ...
        毕业论文的撰写，均是在刘老师的悉心指导下完成的；
        
        接下来，感谢李颖学姐和刘德琼学姐，她们对我的实验开展提供了及时的指导与帮助，感谢
        刘德琼学姐阅读了我的论文草稿，提出了宝贵的修改建议；同时感谢化工楼B503的研究生
        学长学姐，是他们提供的友好实验氛围与帮助；
        
        再者，还要感谢与我一同开展毕设设计的王樊、往淑钰、许馨瑶同学，感谢
        
        最后，感谢我的父母对我的养育之恩，感谢他们对我学业上的支持和生活上的包容，
    \end{acknowledgement}
