% 本科毕业论文选项
\documentclass[bachelor,adobefonts]{jnuthesis} %Font: winfonts, sourcefonts, adobefonts.% now I replace adobefonts with fandolfonts
...
\begin{document}
    ...
    \begin{englishabstract}
        ...
        \englishkeywords{Switchable Surfactant, Selenium, Vesicle, Redox}
    \end{englishabstract}
